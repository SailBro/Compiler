...
{
       0,   168,   168,   169,   170,   175,   176,   180,   181,   185,
     186,   187
};
#endif
...
{
  "$end", "error", "$undefined", "CHAR", "OR", "CONNECT", "CLOSURE",
  "LEFT_PAR", "RIGHT_PAR", "';'", "$accept", "lines", "expr", "con_expr",
  "term", YY_NULLPTR
};
#endif
...
{
       2,    10,    13,     3,    15,     9,    11,     4,     3,     5,
       3,    12,     4,    10,     4,     0,     0,    14
};

static const yytype_int8 yycheck[] =
{
       0,     4,     8,     3,    10,     4,     9,     7,     3,     9,
       3,     6,     7,     4,     7,    -1,    -1,     8
};
...
yyreduce:
  ...
  case 2:
#line 168 "Thompson.y"
                         { func_printNFA((yyvsp[-1].nval)); }
#line 1450 "y.tab.c"
    break;

  case 5:
#line 175 "Thompson.y"
                           { (yyval.nval)=func_or((yyvsp[-2].nval),(yyvsp[0].nval)); }
#line 1456 "y.tab.c"
    break;
...
#line 1462 "y.tab.c"
  ...
  case 7:
#line 180 "Thompson.y"
                        { (yyval.nval)=func_connect((yyvsp[-1].nval),(yyvsp[0].nval)); }
#line 1468 "y.tab.c"
    break;
...
#line 1474 "y.tab.c"
  ...
  case 9:
#line 185 "Thompson.y"
                       { (yyval.nval)=func_closure((yyvsp[-1].nval)); }
#line 1480 "y.tab.c"
    break;
...
#line 1486 "y.tab.c"
  ...
  case 11:
#line 187 "Thompson.y"
               { (yyval.nval)=func_char((yyvsp[0].cval)); }
#line 1492 "y.tab.c"
    break;
